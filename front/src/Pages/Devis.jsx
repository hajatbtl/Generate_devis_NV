...
const Devis = () => {
    ...
    const [valuevisite, setValuevisite] = useState(1);
    const onChangeradiovisite = (e) => {
        console.log('radio checked', e.target.value);
        setValuevisite(e.target.value);
    };
    const [valueprevue, setValueprevue] = useState(1);
    const onChangeradioprevue = (e) => {
        console.log('radio checked', e.target.value);
        setValueprevue(e.target.value);
    };
                                ...
                                <Col xl={6}> <label>Condition d'execution </label> </Col>
                                    ...
                                    <Col xl={6} className='mt-3'>
                                        <Radio.Group onChange={onChangeradiovisite} value={valuevisite}>
                                            <Radio value={'Avec une visite préavis'}>Avec une visite préavis</Radio>
                                            <Radio value={'Sans une visite préavis'}>Sans une visite préavis</Radio>
                                        </Radio.Group>
